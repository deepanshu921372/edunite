        ...
        >
          ...
          <div className="p-6 relative">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Total Teachers</h3>
        ...
        >
          ...
          <div className="p-6 relative">
            ...
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-gray-900">{approvedTeachers}</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-6 relative">
            ...
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-gray-900">{pendingTeachers}</p>
            </div>
          </div>
        </motion.div>
      </div>
